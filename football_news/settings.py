...
SECRET_KEY = 'django-insecure-vk)79m42mpm^7g9j$w$xs@ocmimk+xo(1$ekn=l4&94v$#)pb#'

PRODUCTION = os.getenv('PRODUCTION', 'False').lower() == 'true'
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost", "127.0.0.1","muhammad-fadhlurrohman-footballnews.pbp.cs.ui.ac.id","10.0.2.2"]

CSRF_TRUSTED_ORIGINS = [
    "https://muhammad-fadhlurrohman-footballnews.pbp.cs.ui.ac.id"
]
